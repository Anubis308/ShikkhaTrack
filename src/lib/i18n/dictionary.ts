export const defaultDictionary = {
  "app.name": "ShikkhaTrack",
  "nav.profile": "Profile",
  "nav.logout": "Log out",
  "auth.welcome": "Welcome back",
  "auth.subtitle": "Sign in to log cases, reply to students, and watch the support desk.",
  ...
  "profile.subtitle": "Signed-in user details from Blocks IAM. Copy your user id if a manager needs to add you as staff.",
  "notFound.title": "404",
